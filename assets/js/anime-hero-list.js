    ...
    characters: [
      {
        ...
        bgImage: "./assets/images/hero/nier_bg.webp",
        cards: [
          { title: "Yorha 2B", description: "Elite combat android eliminating machine lifeforms." },
          { title: "Built for Battle", description: "Advanced weaponry and acrobatic strength." },
          { title: "More Than a Weapon", description: "Hidden struggle with memory, loss, and identity." }
        ]
      }
    ]
  },
    ...
    characters: [
      {
        ...
        cards: [
          { title: "Cosplay Queen", description: "Passionate about cosplay and creativity." },
          { title: "Energetic & Fun", description: "Brings energy to everyone around her." },
          { title: "Friendly & Bold", description: "Confident and supportive friend." }
        ]
      }
    ]
  }
